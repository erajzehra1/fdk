                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-breadcrumb">
                            <h4 style="margin-top: -35px;">All Emails</h4>
                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: inline-flex;">
                                            ...
                                            <button type="button"   class="openBtn btn btn-success  " data-toggle="modal" data-target="#myModal" data-id="<?php echo  $row['id'] ?>"><div>Reply</div></button>
        ...
        <script>
            ...
            $(document).ready(function(){
                $('#myModal').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                        type : 'post',
                        url : 'fetchemail.php', //Here you will fetch records
