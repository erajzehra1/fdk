                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-breadcrumb">
                            <h4 style="margin-top: -35px;">Change About</h4>
                            <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#add-contact">Change About</button>
                        </div>
                        <br>
                        <hr>
                            ...
                            <table id="zero_config" class="table m-t-30  table-hover contact-list table-striped  table-bordered" data-page-size="10">
                               ...
                               $row = mysqli_fetch_array($result);
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="img img-thumbnail" src="../../../img/category/<?php echo $row['image'] ?>" alt="">
                                        </td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal form-material" method="post" action="inlcudes/about.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="row">
                                    <textarea id="ckeditor" class="ckeditor" name="ckeditor" cols="30" rows="10">
                                ...
                                <div class="row">
                                    <div class="col-md-6 m-b-20">
                                        <img class="img img-thumbnail" src="../../../img/category/<?php echo $row['image'] ?>" alt="" style="width: 200px;height: 200px">
                                    </div>
