                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-breadcrumb">
                            <h4 style="margin-top: -35px;">All admin</h4>
                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: inline-flex;">
                                            <a class="delete"  href="inlcudes/dlt_admin.php?id=<?php echo $row['id'] ?>" class="delete" data-confirm="Are you sure to delete this item?"><button class="btn btn-danger"><div><i class="fa fa-trash"></i></div></button>
                                            </a>
...
<div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form-material" method="post" action="inlcudes/admin.php" enctype="multipart/form-data">
